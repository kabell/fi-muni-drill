...
def question(request, mode=None, filename=None, id=None, poradie=None, answer=None):
    ...
    uspestnost_class='progress-bar-danger'
    if uspesnost>60:
        uspestnost_class = 'progress-bar-warning'
    if uspesnost>85:
        uspestnost_class = 'progress-bar-success'
    ...
    return render_to_response('question1.html', locals())
